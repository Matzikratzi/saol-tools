...
'''
    ...
    new_result_start = (
        "    global _LEFT_A_X, _LEFT_LEVELS, _LEFT_LEVEL_COUNTS, _LEFT_IGNORED_HEADINGS, _LEFT_PREFIX_PAIRS, _HAF_LEVELS, _LEFT_THRESHOLD_X, _SYNTHETIC_ARTICLE_ROWS\n"
        ...
        "                continue\n"
        "            if any(min(line.bottom, band_bottom) - max(line.top, band_top) > 0 for line in existing):\n"
        "                continue\n"
        "            crop_left = scan_x0\n"
